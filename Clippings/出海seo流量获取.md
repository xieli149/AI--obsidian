---
title: "用好 AI 跟上时代"
source: "https://scys.com/articleDetail/xq_topic/14422442285288512"
author:
  - "[[作者]]"
published:
created: 2026-06-11
...
先前一直很关注出海相关的事情，也参加过几次航海，尤其是SEO流量获取，但是一直也没有靠搜索引擎拿到过像样的流量。去年底也加入了哥飞老师社群，学习SEO相关的知识。

但此前多是看别人怎么做，直到今年五月份，我才第一次动手尝试出海SEO，选择了一个反馈比较快的新词方向，做了一个英文小游戏站点，最后拿到了这个词5月份的大部分流量，同时也拿到了哥飞朋友们社群 5 月新词比赛的第一名。
...
![](https://article-images.zsxq.com/Fvui6P4gM9FknKC8CXVPIeHn3qUG?imageMogr2/auto-orient/format/jpg/quality/75)
...
我从用户视角体验一下我的游戏站，发现了一些小问题。尤其是UI 方面：我们昨天第一天上的那个分享和留言墙功能，在桌面端的 UI 还可以，但在移动端有些被截断了、有些是样式乱了，小游戏移动端用户又很多，比较影响用户体验。我当即在 [claude.md](http://claude.md/) 和 [agent.md](http://agent.md/) 里加了一条规则：每次涉及 UI 改造，发布前必须检查移动端效果。
...
![](https://article-images.zsxq.com/FpySchWZ7fcPmMSWesWnuFics0Uy?imageMogr2/auto-orient/format/jpg/quality/75)

所有关键字搜索情况，主要来源是多语言和错别字，以及其他内页覆盖的长尾关键字

![](https://article-images.zsxq.com/FmORTVO9lYl3VltsFB_MzITVjHDo?imageMogr2/auto-orient/format/jpg/quality/75)

GA4图，低谷期的每天依旧有20k左右的访客

![](https://article-images.zsxq.com/Fjnu9TAXRfSXSPWKMz2wnogbyf1a?imageMogr2/auto-orient/format/jpg/quality/75)
...
![](https://article-images.zsxq.com/FqwpNqhHyoq5bRg4MShbNifhLw7H?imageMogr2/auto-orient/format/jpg/quality/75)
